...
const ACCENT = "#6F69C9"; // periwinkle title accent (AA on the light field)
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-xl px-6">
        ...
        <section className="relative pt-14 md:pt-20">
          {/* Dense central radial halo so the ghost wordmark reads clearly. */}
          <div
            aria-hidden
            className="pointer-events-none absolute left-1/2 top-[34%] -z-0 h-[420px] w-[520px] -translate-x-1/2 -translate-y-1/2 blur-2xl"
            style={{
              background:
                "radial-gradient(50% 50% at 50% 50%, rgba(214,228,255,0.85) 0%, rgba(214,228,255,0) 70%)",
            }}
          />
